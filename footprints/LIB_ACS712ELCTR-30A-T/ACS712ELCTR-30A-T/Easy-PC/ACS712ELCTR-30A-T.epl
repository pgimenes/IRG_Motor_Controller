SamacSys ECAD Model
566205/737959/2.49/8/2/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "ACS712ELCTR-30A-T" (originalName "ACS712ELCTR-30A-T")
	...
	(compDef "ACS712ELCTR-30A-T" (originalName "ACS712ELCTR-30A-T") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		(compPin "1" (pinName "IP+_1") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "2" (pinName "IP+_2") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "3" (pinName "IP-_1") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "4" (pinName "IP-_2") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "8" (pinName "VCC") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "7" (pinName "VIOUT") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "6" (pinName "FILTER") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "5" (pinName "GND") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "ACS712ELCTR-30A-T"))
		...
		(attr "Manufacturer_Part_Number" "ACS712ELCTR-30A-T")
		(attr "Mouser Part Number" "")
		(attr "Mouser Price/Stock" "")
		(attr "Arrow Part Number" "ACS712ELCTR-30A-T")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/acs712elctr-30a-t/allegro-microsystems?region=nac")
		(attr "Description" "Fully Integrated, Hall-Effect-Based Linear Current Sensor IC with 2.1 kVRMS Voltage Isolation and a Low-Resistance Current Conductor")
		(attr "Datasheet Link" "https://www.allegromicro.com/-/media/files/datasheets/acs712-datasheet.ashx")
		(attr "Height" "1.75 mm")
	)
